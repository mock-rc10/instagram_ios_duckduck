...
class ProfileDataManager{
    func GetProfile(delegate: ProfileViewController, token: String?) {
        AF.request("\(Constant.BASE_URL)/api/users/profile", method: .get,parameters: nil,headers:  ["X-ACCESS-TOKEN": token!])
            .responseDecodable(of: ProfileLookupResponse.self) { response in
